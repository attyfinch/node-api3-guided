...
const middlewarePipeline = [checkHubId, checkNewHub]
...
// could also group middleware here in an array
// can just list out as well
// I'm choosing to save it in a variable so it's cleaner.

router.put('/:id', middlewarePipeline, (req, res, next) => {
...
router.use((error, req, res, next) => {
  res.status(error.status || 500).json({
    ...
    customMessage: 'Oh no. You broke something in hubs-router'
  })
})
